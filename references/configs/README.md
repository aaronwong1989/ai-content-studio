...
```bash
# 指定角色库
ai-studio dialogue --source "内容.txt" --roles configs/studio_roles.json -o out.mp3

# MiniMax 引擎独立使用
ai-studio dialogue --source dialogue.txt --roles configs/studio_roles.json -o out.mp3
```
...
```bash
ai-studio dialogue --source "内容.txt" --roles configs/roles.json -o out.mp3
```
